...
const Login = () => {
  ...
  const handleGoogleSuccess = async (credentialResponse) => {
    ...
    try {
      ...
      // The backend returns both access_token, refresh_token, and user data
      ...
      // Pass the user data to ensure it's properly saved in the context
      const success = await contextLogin(access_token, null, {
        ...userData,
      ...
      if (success) {
        ...
        throw new Error('Failed to complete Google login - authentication failed');
      }
    } catch (err) {
