 ...
 * @returns {string|null} The current authentication token or null if not found/expired
 */
...
export const login = async (email, password) => {
  try {
    ...
    if (response.data && response.data.access_token) {
      const { access_token, refresh_token, expires_in, token_type = 'Bearer' } = response.data;
